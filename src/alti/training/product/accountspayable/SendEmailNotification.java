...
public class SendEmailNotification extends PdfRead {
	protected void send(String from, String password, String to, String sub, String msg) {
		...
		try {
           ...
           String htmlText = "<H1>for furthur updates contact ERP Altimetrik  </H1><img src=\"cid:image\">";
            ...
            DataSource fds = new FileDataSource("C:\\Users\\svc-note\\Downloads\\Approved.jpg");
